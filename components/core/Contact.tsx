...
export default function Contact() {
  return (
    ...
    <div className="flex bg-dark-green px-24 py-10 justify-center">
      <div id="contact" className='flex flex-col gap-5 bg-dark-green text-white items-center p-12'>
            <span className='font-bold text-2xl'>Contact Me</span>

            <p>Please feel free to reach out! I would love connect and discuss open opportunities and receive any feedback 
                on my work.</p>
